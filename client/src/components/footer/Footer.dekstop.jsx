...
const FooterDesktop = (props) => {
  return (
    <Grid 
      container 
      sx={{maxWidth : 1600, height : "95%", color : "white", textAlign : "center"}}
    >
      <Grid container md={3} sx={{height : "100%"}}>
        <Grid container sx={{minWidth : "100%", alignItems : "center", justifyContent : "center"}}>
          <img src="/assets/logo.png" alt="logo" style={{width : 200}}/>
        </Grid>
        <Grid container sx={{minWidth : "100%", justifyContent : "center"}}>
          <Grid sx={{width : 250}}>
            <Typography variant="h4" sx={{mb : 2, textAlign : "start"}}>Social Media</Typography>
      ...
      <Grid container direction="column" alignItems="center" justifyContent="center" sx={{height : "100%"}} md={2}>
        <Box sx={{textAlign : "start", height : 300}}>
          <Typography variant="h4" sx={{mb : 2}}>Menu</Typography>
      ...
      <Grid container direction="column" alignItems="center" justifyContent="center" sx={{height : "100%"}} md={4}>
        <Box sx={{textAlign : "start", height : 300}}>
          <Grid sx={{mb : 5}}>
            ...
            <Typography variant="body3">Jl. Letjen S Parman No. 58, Petisah Tengah, Kec. Medan Petisah, Kota Medan, Sumatera Utara 20111</Typography>
          </Grid>

          <Grid>
            <Typography variant="h4" sx={{mb : 1}}>Operational Hours</Typography>
            <Typography variant="body3">Monday - Sunday 08.00 - 23.00 (GMT+7)</Typography>
          </Grid>
        </Box>
      </Grid>
    </Grid>
