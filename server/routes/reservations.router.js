...
const {createReservation, getAllReservations, getReservation, deleteReservation, restoreDeletedReservation, editReservation} = require("../controller/reservations.controller");
